function [Datastr] = S10_toOS(Datastr, osFolder, permVec, removeEndFrames, CoPOffset)
% gBMPDynUI osFolder=1; permVec=1; removeEndFrames=1; CoPOffset =1;
% 
...
if isfield(Datastr.Resample,'Force')  % Create .mot file (kinetic data)
    Datastr = getMot(Datastr,[subjroot '\' osFolder '\' subjroot(bckslsh(end)+1:end) trial], removeEndFrames, CoPOffset);
else
