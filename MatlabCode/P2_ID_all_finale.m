...
%% -------------------- LOAD DATA --------------------
load('C:\Users\Dottorato\OneDrive - University of Twente\Data\MATLAB\P2_rep1_ID_finale.mat')
load('C:\Users\Dottorato\OneDrive - University of Twente\Data\MATLAB\P2_rep2_ID_finale.mat')
load('C:\Users\Dottorato\OneDrive - University of Twente\Data\MATLAB\P2_rep3_ID_finale.mat')
load('C:\Users\Dottorato\OneDrive - University of Twente\Data\MATLAB\P2_rep4_ID_finale.mat')
...
rep1_IK = mean(Rep1_ID);
rep2_IK = mean(Rep2_ID);
rep3_IK = mean(Rep3_ID);
rep4_IK = mean(Rep4_ID);
